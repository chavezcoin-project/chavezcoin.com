...
This is the primary site for [Chavezcoin.tk](https://www.chavezcoin.tk).  It is
a Cryptocurrency site that permits access to chavezcoins, which are available by the website and are distributed on a daily basis to users.
...
[Ruby](https://rvm.io/rvm/upgrading) `~> 2.3.3`. To install bundler:
